...
checkWall:
	...
	beq	checkBrickLeft		//Then check if hit a brick
...
checkBrickRight:
	bl	brickRightCollide	//Check for a brick Right collision	
	cmp	r0, #0			//If no collision
	beq	checkBrickTop		//Test if the top of the brick has been hit
	bl	Update_Bricks		//If collision, update the brick values
	bl	increaseScore		//If collision, increase game score
	b	sideWall		//Then bounce the ball like it has hit a side wall
...
checkBrickTop:
	...
	cmp	r0, #0			//If no collision
	beq	checkBrickBottom	//Test if the bottom of the brick has been hit
	bl	Update_Bricks		//If collision, update the brick values
	bl	increaseScore		//If collision, increase game score
